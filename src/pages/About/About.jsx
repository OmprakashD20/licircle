    ...
    <>
      ...
      <div className="py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto my-16 max-w-2xl sm:my-20 lg:my-24 lg:max-w-4xl flex items-center justify-center">
          ...
          <div className="mx-auto max-w-4xl text-center">
            <p className="mt-10 text-base sm:text-lg sm:leading-8 font-oxygen text-gray-600">
              ...
              batteries' State of Health and maximize their remaining useful
              life.{" "}
