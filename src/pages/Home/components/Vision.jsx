  ...
  return (
    <div className="container w-full my-4 mb-8 pt-8 p-4 mx-auto">
      <SlideFromLeft delay={0}>
        <div className="relative mx-auto md:max-w-2xl pt-6 min-w-0 break-words bg-gray-100 border-2 border-green-500 w-full mt-4 mb-12 hover:shadow-lg shadow-lg hover:scale-105 transition-all duration-300 hover:cursor-pointer rounded-xl">
