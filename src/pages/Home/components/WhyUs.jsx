...
const WhyUsCard = () => {
  return (
    <section className="container w-full my-4 mb-12 pt-8 p-4 mx-auto">
      <div className="relative mx-auto max-w-5xl text-center">
        <p className="font-bebasNeue font-bold xs:text-6xl min-[320px]:text-5xl text-4xl">
          ...
          <span className="relative whitespace-nowrap">
            ...
            <span className="text-primary">LiCircle</span>
          </span>
        </p>
      </div>
      <div className="relative mx-auto max-w-7xl grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div
            ...
            className={`border-2 ${
              index == 0
                ...
                ? "border-indigo-500"
                : "border-purple-500"
            } rounded-md p-6 text-center hover:shadow-lg shadow-lg hover:scale-105 transition-all duration-500 hover:cursor-pointer`}
          >
            <div
            ...
            >
              <img src={reason.icon} alt={reason.name} height={36} width={36} />
            </div>
